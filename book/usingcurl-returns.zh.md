...
48. 指定为LICORL的未知选项.如果使用与底层LBCURL版本不同步的cURL版本,可能会发生这种情况.也许您的新curl尝试使用旧libcurl中的一个选项,该选项直到您使用的libcurl版本之后才引入,但是您的curl工具代码知道这个选项比较新.为了减少这种风险并确保它不会发生:使用相同版本号的cURL和libcurl.
